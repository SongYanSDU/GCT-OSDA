...
from main_models import build_feature_extractor_bjut,  build_doc_model
from data_loader import bjut_dataset, bjut_dataset_3, bjut_dataset_4
import os
...
# 数据加载和准备
(data1_3, label1_3, data2_3, label2_3, data3_3, label3_3, data4_3, label4_3,
data5_3, label5_3, data6_3, label6_3, data7_3, label7_3, data8_3, label8_3) = bjut_dataset_3()
...
'''label3 = np.where(label3 >= num_classes, num_classes, label3)
...
label7 = np.where(label7 >= num_classes, num_classes, label7)
label8 = np.where(label8 >= num_classes, num_classes, label8)'''
# 定义训练和测试对
source_data_1 = np.concatenate((data1_3, data2_4), axis=0)
source_labels_1 = np.concatenate((label1_3, label2_4), axis=0)
source_data_2 = np.concatenate((data2_3, data3_4), axis=0)
source_labels_2 = np.concatenate((label2_3, label3_4), axis=0)
source_data_3 = np.concatenate((data3_3, data4_4), axis=0)
source_labels_3 = np.concatenate((label3_3, label4_4), axis=0)
source_data_4 = np.concatenate((data4_3, data5_4), axis=0)
source_labels_4 = np.concatenate((label4_3, label5_4), axis=0)
source_data_5 = np.concatenate((data5_3, data6_4), axis=0)
source_labels_5 = np.concatenate((label5_3, label6_4), axis=0)
source_data_6 = np.concatenate((data6_3, data7_4), axis=0)
source_labels_6 = np.concatenate((label6_3, label7_4), axis=0)
